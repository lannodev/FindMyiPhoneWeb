...
L.Playback.Util = L.Class.extend({
  statics: {
    ...
    DateStr: function(time) {
        ...
        return new Date(time).toLocaleDateString('pt',options);
    },
...
L.Playback.DateControl = L.Control.extend({
    ...
    onAdd : function (map) {
        this._container = L.DomUtil.create('div', 'controles leaflet-control-layers leaflet-control-layers-expanded');
...
L.Playback.PlayControl = L.Control.extend({
    ...
    onAdd : function (map) {
        this._container = L.DomUtil.create('div', 'controles ');
        ...
        this._button = L.DomUtil.create('div', 'btn btn-default', playControl);
